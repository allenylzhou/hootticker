OAuth2.adapter('hootsuite', {
  ...
  redirectURL: function(config) {
    return 'https://hootsuite.com/robots.txt';
  },
  ...
  accessTokenURL: function() {
    return 'https://hootsuite.com/oauth2/token';
  },
  ...
  accessTokenParams: function(authorizationCode, config) {
    return {
      ...
      username_password: btoa(config.clientId + ':' + config.clientSecret),
